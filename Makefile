...
texlive.libs:
	tlmgr install moderncv polyglossia luatexbase pgf tikzmark qrcode contour newcomputermodern lh collection-langcyrillic russian #   cm-super   cyrillic-modern
	fmtutil-sys --all
